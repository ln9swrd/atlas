...
| G4 | issue #5 정리 (프로젝트 SERA 폐기 반영, 남은 범위만) | **Done** |
| G5 | (선택) 잔여 Sera=project 문구 정리 | **Done** — VISION, ENVIRONMENTS, 05_AGENTS, AGENT_REGISTRY, ATLAS_GIT_REBUILD_PLAN |
| G6 | (선택) Open Q #4·#6·#7 문서 초안만 | **Pending** |

**G1–G5 Done.** 선택 잔여: G6. 집 PC: L-1.
