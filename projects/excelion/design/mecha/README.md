...
| `ORDER_DESIGN_LANGUAGE.md` | ORDER 계열 실루엣·색 방향 · **슈퍼로봇 과장** |
...
ord-* · creil · aegis · seth → 실루엣 후보 확정 전 **최종 삼면도 STOP**.  
CANON 전투는 `*_FINAL_SPEC` / `ORD_FINAL_SPEC`.  
**군사·건축 비유(벽·탑·요새) 금지 · 오더 진영 개성·슈퍼로봇 톤.**
