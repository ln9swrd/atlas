...
**계층:** [`CANON_HIERARCHY.md`](CANON_HIERARCHY.md) — Master 승인 SoR (2026-08-14).
...
FSS 문서는 Reference. TEXT-LOCK을 덮어쓰지 않는다.
...
6. **이중 구조(스펙 vs 제작) 유지** — 합치지 않음
7. FSS는 Reference. Canon 계층을 덮어쓰지 않음
...
- [`CANON_HIERARCHY.md`](CANON_HIERARCHY.md)
- [`DESIGN_REORGANIZATION_PLAN.md`](DESIGN_REORGANIZATION_PLAN.md)
