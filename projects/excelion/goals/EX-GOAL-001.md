...
## Mission
Start the first playable prototype for Excelion by establishing the initial planning, backlog, and production pipeline structure.

## Objectives
1. Review the Excelion Project Charter.
...
- Follow the Excelion Project Charter.
...
## Operating Principle
Atlas does not change Excelion. Only repeatable bottlenecks discovered in Excelion may be proposed as Atlas improvements.
