...
> 2026-08-08 · **EP01 경로 갱신: 2026-08-09 Master 결정 B**
...
- **감사/체크포인트**: 보완 작업용.
- **LEGACY / ALTERNATE**: 보존하되 정본 인용·편집의 기준이 아님.
...
| 파일 | 판정 | 비고 |
|------|------|------|
| `EP01_세계가_끝났는데_나는_아직_여기_있다.md` | **정본 (EP01)** | **P-B · Master B LOCK (2026-08-09)** |
| `EP01_마지막_기동/Scene01~06` | **LEGACY / ALTERNATE** | 보존 · 정본 아님 · Enhancement 이력 있음 |
| `EP01_REWRITE.md` | **ENHANCEMENT / OUTLINE** | 아웃라인·목적·필수 장면 체크. 본문 아님. |
| `ep02.md` ~ `ep24.md` | **정본** | CURRENT_STATE 기준 EP1–24 본문 Done. 밀도 차이 있음. |

**주의**: 단일 `ep01.md` 없음. EP01 정본 = **P-B** (`EP01_세계가_끝났는데_나는_아직_여기_있다.md`).
...
| C-02 | EP01 본문이 3종 공존 | 중 | **2026-08-09 Master B: P-B 정본 LOCK** · P-A LEGACY · P-C OUTLINE |
| C-03 | ep01.md 부재 | 낮 | P-B 경로 사용 · 통합 파일은 별도 승인 시 |
...
**이야기 본문**
- EP01: `EP01_세계가_끝났는데_나는_아직_여기_있다.md` (**P-B · Master B**)
- EP02~24: `ep02.md` ~ `ep24.md`
- EP01 LEGACY: `EP01_마지막_기동/` (보존 · 비정본)
