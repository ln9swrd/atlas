...
poses = [
    {"location": (0.0, 0.0, 0.0), "rotations": {"thigh.L": (42, 0, 0), "thigh.R": (-35, 0, 0), "shin.L": (-18, 0, 0), "shin.R": (52, 0, 0), "upper_arm.L": (-28, 0, 0), "upper_arm.R": (28, 0, 0)}},
    {"location": (0.0, 0.0, 0.02), "rotations": {"thigh.L": (12, 0, 0), "thigh.R": (12, 0, 0), "shin.L": (58, 0, 0), "shin.R": (-8, 0, 0), "upper_arm.L": (22, 0, 0), "upper_arm.R": (-22, 0, 0)}},
    {"location": (0.0, 0.0, 0.0), "rotations": {"thigh.L": (-35, 0, 0), "thigh.R": (42, 0, 0), "shin.L": (52, 0, 0), "shin.R": (-18, 0, 0), "upper_arm.L": (28, 0, 0), "upper_arm.R": (-28, 0, 0)}},
    {"location": (0.0, 0.0, 0.02), "rotations": {"thigh.L": (12, 0, 0), "thigh.R": (12, 0, 0), "shin.L": (58, 0, 0), "shin.R": (-8, 0, 0), "upper_arm.L": (22, 0, 0), "upper_arm.R": (-22, 0, 0)}},
    {"location": (0.0, 0.0, 0.0), "rotations": {"thigh.L": (42, 0, 0), "thigh.R": (-35, 0, 0), "shin.L": (-18, 0, 0), "shin.R": (52, 0, 0), "upper_arm.L": (-28, 0, 0), "upper_arm.R": (28, 0, 0)}},
    {"location": (0.0, 0.0, 0.0), "rotations": {"thigh.L": (42, 0, 0), "thigh.R": (-35, 0, 0), "shin.L": (-18, 0, 0), "shin.R": (52, 0, 0), "upper_arm.L": (-28, 0, 0), "upper_arm.R": (28, 0, 0)}},
]
