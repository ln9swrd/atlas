...
poses = [
    {"location": (0.0, 0.0, 0.0), "rotations": {"thigh.L": (28, 0, 0), "thigh.R": (-28, 0, 0), "shin.L": (-12, 0, 0), "shin.R": (-12, 0, 0), "upper_arm.L": (-12, 0, 0), "upper_arm.R": (12, 0, 0)}},
    {"location": (0.0, 0.0, 0.0), "rotations": {"thigh.L": (18, 0, 0), "thigh.R": (-18, 0, 0), "shin.L": (48, 0, 0), "shin.R": (48, 0, 0), "upper_arm.L": (-18, 0, 0), "upper_arm.R": (18, 0, 0)}},
    {"location": (0.0, 0.0, 0.9), "rotations": {"thigh.L": (8, 0, 0), "thigh.R": (-8, 0, 0), "shin.L": (82, 0, 0), "shin.R": (82, 0, 0), "upper_arm.L": (-28, 0, 0), "upper_arm.R": (28, 0, 0)}},
    {"location": (0.0, 0.0, 1.6), "rotations": {"thigh.L": (0, 0, 0), "thigh.R": (0, 0, 0), "shin.L": (18, 0, 0), "shin.R": (18, 0, 0), "upper_arm.L": (-35, 0, 0), "upper_arm.R": (35, 0, 0)}},
    {"location": (0.0, 0.0, 0.9), "rotations": {"thigh.L": (8, 0, 0), "thigh.R": (-8, 0, 0), "shin.L": (82, 0, 0), "shin.R": (82, 0, 0), "upper_arm.L": (-28, 0, 0), "upper_arm.R": (28, 0, 0)}},
    {"location": (0.0, 0.0, 0.0), "rotations": {"thigh.L": (28, 0, 0), "thigh.R": (-28, 0, 0), "shin.L": (-12, 0, 0), "shin.R": (-12, 0, 0), "upper_arm.L": (-12, 0, 0), "upper_arm.R": (12, 0, 0)}},
]
